...
$sql_pelajar = "SELECT * FROM home WHERE user_id = '".$_SESSION['user_id']."'";
		  ...
		  <div class="row-fluid">
            ...
            <th>Status</th>
				...
				<?php if($total_pelajar>0) { do { ?>   <tr>
                                  ...
                                  <td class="numeric">
                                  <?php 
                                  if($rows_pelajar['status']==0)
                                  {
                                    echo "<font color='orange'>Iklan masih dalam proses</font>";
                                  }
                                  else if($rows_pelajar['status']==1)
                                  {
                                    echo $rows_pelajar['valid_until'];
                                  }
                                  else if($rows_pelajar['status']==2)
                                  {
                                  ...
                                  if($rows_pelajar['status']==0)
                                  {
                                    echo "<font color='orange'>Dalam proses</font>";
                                  }
                                  else if($rows_pelajar['status']==1)
                                  {
                                    echo "<font color='green'>Diluluskan</font>";
                                  }
                                  else if($rows_pelajar['status']==2)
                                  {
                                    echo "<font color='red'>Iklan diberhentikan</font>";
                                  }
                                    ?>
