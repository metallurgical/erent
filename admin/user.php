...
$sql_pelajar = "SELECT * FROM user where role='penyewa' or role = 'pemilik'";
			...
			<table class="table table-striped table-bordered table-condensed">
               ...
               <?php if($total_pelajar>0) { do { ?>   <tr>
                     ...
                     <i class="icon-pencil"></i> </a>
                          <a href="del.php?id=<?php echo $rows_pelajar['user_id'];?>" title="padam" onclick="return confirm('Anda Pasti Untuk Padam?')"> 
